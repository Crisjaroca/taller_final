const urlApi = "http://localhost/Proyectos/taller_final/salidas";
const urlApiE = "http://localhost/Proyectos/taller_final/entradas";
const urlApiP = "http://localhost/Proyectos/taller_final/personas";
const urlApiO = "http://localhost/Proyectos/taller_final/objetos";
let listaSalidas = [];
let listaEntradas = [];
let listaPersonas = [];
let listaObjetos = [];
