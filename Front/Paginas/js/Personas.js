const urlApi = "http://localhost/Proyectos/taller_final/personas";
const urlApiE = "http://localhost/Proyectos/taller_final/entradas";
const urlApiS = "http://localhost/Proyectos/taller_final/salidas";
let listaPersonas = [];
let listaEntradas = [];
let listaSalidas = [];
let idpersona = 0;
...
function validarPersonasR(idpersona){
    ...
    if(val!=false){
        window.alert("La persona no se puede eliminar debido a que tiene un registro");
    }else{
        window.alert("Esta persona no tiene registros");
    }
}
